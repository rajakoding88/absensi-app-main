            ...
            <div class="col-md-6 mb-3 mb-md-0">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="<?php echo e(route('presences.permissions', $attendance->id)); ?>" class="badge text-bg-info">Karyawaan
                        Izin</a>
                    <a href="<?php echo e(route('presences.not-present', $attendance->id)); ?>" class="badge text-bg-danger">Belum
                        Absen</a>
...
} elseif ($_instance->childHasBeenRendered('1S2t5Gv')) {
    $componentId = $_instance->getRenderedChildComponentId('1S2t5Gv');
    $componentTag = $_instance->getRenderedChildComponentTagName('1S2t5Gv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1S2t5Gv');
} else {
    $response = \Livewire\Livewire::mount('presence-table', ['attendanceId' => ''.e($attendance->id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('1S2t5Gv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\skripsi Ophy\absensi-app-main\resources\views/presences/show.blade.php ENDPATH**/ ?>